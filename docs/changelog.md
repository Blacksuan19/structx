...
## [Unreleased](https://github.com/Blacksuan19/structx/compare/0.6.5...HEAD)

## 2026-09-22

### [0.6.4 - 0.6.5](https://github.com/Blacksuan19/structx/compare/0.6.3...0.6.5)

- docs(measurement): document parallel OCR workers and their limits [`f2a6984`](https://github.com/Blacksuan19/structx/commit/f2a698406440447daeb1b99d08b3dd22bb3e0aa7)
- test(measurement): cover parallel OCR ordering batching and lock release [`bbdd32d`](https://github.com/Blacksuan19/structx/commit/bbdd32de582516695a96f9c2a9edae07840458f2)
- perf(measurement): recognize pages in parallel outside the pdf lock [`2d06e16`](https://github.com/Blacksuan19/structx/commit/2d06e16aadcc3fa38d63d31a8360f1599e8fbb1a)
- docs(measurement): document measurement API and optional extras [`0db6ca5`](https://github.com/Blacksuan19/structx/commit/0db6ca5c309a92a0c63fd9de3ec07f309295e3f4)
- test(measurement): cover count status and optional OCR boundaries [`38ad7c5`](https://github.com/Blacksuan19/structx/commit/38ad7c53c1285897480d416d0f89664778a3cf18)
- feat(measurement): add standalone document measurement API [`6d2fe3e`](https://github.com/Blacksuan19/structx/commit/6d2fe3e9f1b56d109969cacc861a6e8a5eed3d7a)

## 2026-07-12

### [0.6.3](https://github.com/Blacksuan19/structx/compare/0.6.2...0.6.3)

- chore(uv.lock): sync package version [`cc5f37a`](https://github.com/Blacksuan19/structx/commit/cc5f37aed3b360d853b3e585a9ae27d6578df332)
- docs(input): document prepared input lifecycle [`843b420`](https://github.com/Blacksuan19/structx/commit/843b420b776a8dd66051d6a4cffb28cb21e4b82a)
- feat(input): add reusable prepared input contexts [`e4d5dd8`](https://github.com/Blacksuan19/structx/commit/e4d5dd884d74df92b539ceebb2b2113769474073)

## 2026-07-11

### [0.6.0 - 0.6.2](https://github.com/Blacksuan19/structx/compare/0.5.1...0.6.2)

- chore(release): align conventional version bumps [`a63a5e8`](https://github.com/Blacksuan19/structx/commit/a63a5e8952c3989b3996ff1d547b447b954bbec1)
- docs(results): clarify JSON serialization [`701e197`](https://github.com/Blacksuan19/structx/commit/701e1978224e4bef496422b4c83727806d960e4e)
- docs(roadmap): plan declarative and semantic validation [`2ff6d06`](https://github.com/Blacksuan19/structx/commit/2ff6d062ad09797bcab37de27c42268a94619339)
- feat(schema): add portable model definition APIs [`0f7ec47`](https://github.com/Blacksuan19/structx/commit/0f7ec471b00d86443cbe4f108ecef52cf77ad043)
- **Breaking change:** refactor(extraction)!: unify row processing pipeline [`eb9b1ab`](https://github.com/Blacksuan19/structx/commit/eb9b1abe81f8bd1a2b8e3d3b588bf44a407dcdfd)
- **Breaking change:** refactor(config)!: adopt pydantic settings [`cedc4f5`](https://github.com/Blacksuan19/structx/commit/cedc4f54519dc8d4b05c9c13911158094688fa21)
- **Breaking change:** refactor(llm)!: simplify planning and usage tracking [`b100786`](https://github.com/Blacksuan19/structx/commit/b10078697a720756cfd63ef3cb2bda66529918aa)

## 2026-07-10

### [0.5.0 - 0.5.1](https://github.com/Blacksuan19/structx/compare/0.4.11...0.5.1)

- chore(pyproject): pin package versions [`5713e7a`](https://github.com/Blacksuan19/structx/commit/5713e7a2a9d7a9f2da072a4f6a6f085c15222cc8)
- refactor(docs): move document processing behind optional docs extra [`a121990`](https://github.com/Blacksuan19/structx/commit/a121990abc689baa65053530788240b431bb0053)
- chore(docs): explicitly include ppt file format [`c1b97ca`](https://github.com/Blacksuan19/structx/commit/c1b97caab9e560e279d4bcbb3ff33801ba3f69cd)
- chore(core): fix pydantic warnings [`a84537d`](https://github.com/Blacksuan19/structx/commit/a84537d678d82b71d3c54a07a8a1dff841e16967)

## 2026-07-09

### [0.4.11](https://github.com/Blacksuan19/structx/compare/0.4.10...0.4.11)

- fix(data_content): use pypdf2 not pypdf [`21ba977`](https://github.com/Blacksuan19/structx/commit/21ba977a42ae5e5cb79f63baebb3e3815cdf1bf7)
- chore(docs,README): update email and links with new domain [`bd79e1a`](https://github.com/Blacksuan19/structx/commit/bd79e1a20d19417bdcbe1e2f7f503110fe9b0893)
